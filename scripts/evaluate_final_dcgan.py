...
GEN_PATH = "generator_mal-dcgan_BASE.pt" 
...
try:
    ...
    plt.savefig("evaluation_dcgan_results.png") # (MỚI) Đổi tên file output
    print(f"\n✅ Đã lưu biểu đồ kết quả vào: evaluation_dcgan_results.png")
